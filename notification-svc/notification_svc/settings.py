...
ROOT_URLCONF = 'notification_svc.urls'
...
WSGI_APPLICATION = 'notification_svc.wsgi.application'

DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.postgresql',
        'NAME': env('DB_NAME', default='notification_db'),
...
DEFAULT_FROM_EMAIL = env('DEFAULT_FROM_EMAIL', default='noreply@waste-management.io')
...
KAFKA_CONSUMER_GROUP = env('KAFKA_CONSUMER_GROUP', default='notification-svc')
KAFKA_TOPICS = env.list('KAFKA_TOPICS', default=['waste-events'])
