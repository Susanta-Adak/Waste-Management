...
- **Waste Collector API** — core REST API (Django REST Framework), connects to PostgreSQL and publishes to the Event Bus
...
- **Database** — PostgreSQL (shared by the Waste Collector API)
